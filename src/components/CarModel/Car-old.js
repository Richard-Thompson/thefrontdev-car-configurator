    ...
    <group ref={group} {...props} dispose={null}>
      <group name="OSG_Scene">
        <mesh
          layers={1}
          castShadow
          receiveShadow rotation={[-Math.PI / 2, 0, 0]} position={[0, -0.15, 0]}>
        ...
        <group name="RootNode_(gltf_orientation_matrix)" scale={[0.01, 0.01, 0.01]} rotation={[-Math.PI / 2, 0, 0]}>

          <group name="RootNode_(model_correction_matrix)">
            <group name="Tesla_Model_Sfbx" rotation={[Math.PI / 2, 0, 0]}>
              <group name="RootNode">
                <group name="wheel003" position={[94.06, 24.63, -179.13]} rotation={[-Math.PI / 2, 0, 0]} scale={1.22}>
                  <mesh
                ...
                <group name="object" scale={[0.1, 0.1, 0.1]}>
                  <mesh
                    layers={1}
                    castShadow
                    name="object_emit_0" geometry={nodes.object_emit_0.geometry} material={materials.emit} />
                </group>
                ...
                <group name="object016" scale={[0.1, 0.1, 0.1]}>
                  <mesh
                    layers={1}
                    castShadow
                    e="object016_refl_0" geometry={nodes.object016_refl_0.geometry} material={materials.refl} />
                </group>
                <group name="cal" position={[94.06, 24.63, 153.98]} rotation={[2.86, 0.3, 0.09]} scale={1.08}>
                  <mesh
