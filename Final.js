...
export default function Model(props) {
  ...
  const { nodes, materials, animations } = useGLTF('/final.gltf')
  ...
  useFrame(() => {
    // if (camSphere.current && camLookAt.current) {
    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
            ...
            <group name="Tesla_Model_Sfbx" rotation={[Math.PI / 2, 0, 0]}>
              <group name="RootNode">
                ...
                <group name="object" scale={0.1029}>
                  <mesh name="object_emit_0"
                    layers={1}
                    geometry={nodes.object_emit_0.geometry} material={materials.emit} />
                </group>
                ...
                <group name="object016" scale={0.1029}>
                  <mesh name="object016_refl_0"
                    layers={1}
                    geometry={nodes.object016_refl_0.geometry} material={materials.refl} />
                </group>
                <group
                  name="wheel"
                  position={[94.0564, 24.6265, 153.9808]}
        ...
        <mesh
          ...
          name="Sphere001"
          layers={1}
          geometry={nodes.Sphere001.geometry} material={nodes.Sphere001.material} />
      </group>
    </group>
  )
}
