...
export default function Model(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/car/final-camera.gltf')
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <group name="Camera" position={[-0.0734, 0.4307, 11.6912]} rotation={[1.534, -0.0002, 0.0063]}>
          <PerspectiveCamera
...
useGLTF.preload('/final-camera.gltf')
